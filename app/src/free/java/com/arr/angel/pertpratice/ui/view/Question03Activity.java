...
public class Question03Activity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        ...
        return Question03Fragment.newInstance(previousQuestionId, previousIsCorrect, previousIsAnswered, topicId);
    }
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        NavigationDrawerMenuMethods.questionDrawerMenuNavigation(Question03Activity.this, menuItem, topicId);
