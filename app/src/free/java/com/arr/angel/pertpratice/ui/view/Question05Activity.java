...
public class Question05Activity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        ...
        return Question05Fragment.newInstance(previousQuestionId, previousIsCorrect, previousIsAnswered, topicId);
    }
