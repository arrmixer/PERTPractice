...
public class Question06Activity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        ...
        return Question06Fragment.newInstance(previousQuestionId, previousIsCorrect, previousIsAnswered, topicId);
    }
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        NavigationDrawerMenuMethods.questionDrawerMenuNavigation(Question06Activity.this, menuItem, topicId);
