...
public class Question06Fragment extends Fragment {
    private static final String TAG = Question06Fragment.class.getSimpleName();
    ...
    //currently this is the last question
    // so int 0 takes user to the results page
    private int nextQuestion = 0;

    //placeholder for current question int
    private int currentQuestion;

    public static Question06Fragment newInstance(int previousQuestionId, boolean correct, boolean answered, int topicId) {
