...
public class RadioGroupHelper {
    ...
    public static void radioButtonLogic(FragmentManager fragmentManager,
                                        int checkId,
...
//                    Toast.makeText(context, "correct!", Toast.LENGTH_SHORT).show();
                    DialogCreations.showCorrectDialog(fragmentManager, nextQuestion, topicId);

                } else {

//                    Toast.makeText(context, "incorrect!", Toast.LENGTH_SHORT).show();
                    DialogCreations.showIncorrectDialog(fragmentManager, nextQuestion, topicId);
