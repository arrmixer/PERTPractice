...
public class Question04Fragment extends Fragment {
    ...
    public static Question04Fragment newInstance(int previousQuestionId, boolean correct, boolean answered, int topicId) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        exampleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), Example4.class);
